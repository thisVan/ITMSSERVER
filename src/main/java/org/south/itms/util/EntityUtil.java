...
//		return listDto;
	...
	public static List<PtableDto> ptableDto(List<Terminal> list, List<Period> listPeriod, List<User> listUser,
		...
		for(PlayTable pt : listPtable) {
			...
			PtableDto ptd = new PtableDto(pt.getTerminalId(),pt.getPid(), pt.getStatusId(), pt.getPlayTotalTime(), pt.getPlayDate(), pt.getScreenRate(), pt.getAllTime(), pt.getPtableName(), pt.getCreateTime(),pt.getModifyTime(), pt.getMin(), pt.getInsertFlag(), pt.getState(), pt.getCheckName(), pt.getCheckTime(), pt.getCheckSecondName(), pt.getCheckSecondTime(), pt.getUnAccessReason(), pt.getPeriodSName(), pt.getStartInterval(), pt.getEndInterval());
	...
	public static List<PtableDto> ptableDtoInsert(List<Terminal> list, List<Period> listPeriod, List<User> listUser,
		...
		for(PlayTable pt : listPtable) {
			...
			PtableDto ptd = new PtableDto(pt.getTerminalId(),pt.getPid(), pt.getStatusId(), pt.getPlayTotalTime(),
					...
					pt.getCreateTime(), pt.getModifyTime(), pt.getMin(), pt.getInsertFlag(), pt.getState(), pt.getCheckName(), pt.getCheckTime(), pt.getCheckSecondName(), pt.getCheckSecondTime(), pt.getUnAccessReason(), pt.getPeriodSName(), pt.getStartInterval(), pt.getEndInterval());
			ptd.setTerminalName(terminalName);
			ptd.setPeriodName(periodName);
			ptd.setPeriodTime(periodTime);
			ptd.setCreateName(userName);
