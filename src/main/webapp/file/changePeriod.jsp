						...
						<tbody>
							<c:forEach items="${periodTwice}" var="period" varStatus="status">
                             ...
                             <c:otherwise> 已生成播表
									...
									<input id='b${period.periodId}' type="button" class="layui-btn" onclick="generateTable('${period.periodId}')" style="margin: 5px;" value="生成播表" />	
                             </c:when>
                             <c:otherwise>
									<input id='b${period.periodId}' type="button" class="layui-btn" onclick="generateTable('${period.periodId}')" style="margin: 5px;" value="已生成" disabled/>	
                             </c:otherwise>
                          </c:choose>
