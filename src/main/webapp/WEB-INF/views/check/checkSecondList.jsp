                    ...
                    if(obj.event === 'mediaView'){
                        $.ajax({
                            ...
                            success: function(msg){
                                ...
                                if(value=="true"){
                                    window.open('<%=request.getContextPath()%>/file/checkSecondVideo.jsp',"_blank","toolbar=yes, location=yes, directories=no, status=no, menubar=yes, scrollbars=yes, resizable=no, copyhistory=yes,left=300,top=20, width=800, height=620");
                                }
                            }
                        });
