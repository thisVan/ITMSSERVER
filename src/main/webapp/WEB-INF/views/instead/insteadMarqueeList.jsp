      ...
      function init(){
    	  ...
    	  layui.use('table', function(){
    		  ...
    		  table.render({
    		    ...
    		    ,cols: [[
    		      //{field:'id', width:'1%'}
    		      {field:'marqName',width:250, event: 'set1', title: 'LOGO/图片叠加名', fixed: true, sort: true}
    		      ,{field:'playDate',width:200, event: 'set4', title: '播放日期', sort: true}
      		      ...
      		      ,{field:'userName',width:120, event: 'set10', title: '创建人', sort: true}
    		  ...
    		  table.on('tool(tableEvent)', function(obj){
    			  ...
    			  if(obj.event === 'resetPtable'){
    				  layer.confirm('真的重置该LOGO/图片叠加么', function(index){
    					  layer.close(index);
    					  $.ajax({
								type: "POST",
								url: "<%=request.getContextPath()%>/ptable/resetMarqueeState.do",
								data: {"mid":mid},
								traditional: true,
								dataType : "json",
		...
		<div class="layui-row layui-col-space1">
		 ...
		 <div class="layui-col-md12">
			...
			<script type="text/html" id="barDemo">
                ...
                <i class="layui-icon">&#xe620;</i>LOGO/图片叠加重置</a>
			</script>
