...
<!-- 		  <div class="input-group">
		  ...
		  <div class="panel panel-default" style="width:33%;height:100%;float:left">
...
<!-- 					<li drag-id="1">1</li>
    ...
    <div class="layui-form-item layui-form-text">
      ...
      <textarea id="mark" placeholder="审核理由" class="layui-textarea"></textarea>
    </div>
    </div>
    <br><br>
<!-- 	        <button type="button" class="btn btn-info" style="margin:5px;" onclick="resetFiles();">重置</button> -->
			...
			<button type="button" class="btn btn-primary" onclick="unFinal()">审核不通过</button>
