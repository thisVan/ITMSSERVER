			...
			table.render({
				...
				where : {
					...
					if (res.fail == 1) {
						...
						document.getElementById("ptableNameTwo").innerHTML = '<font  size="4"  color="red"> 当前播表名：' + res.msg + '</font>' + '<br>播表总时长: ' + ptableTotalDuration + '&nbsp;&nbsp;&nbsp;&nbsp; 播表基频: ' + ptableMaxCommonDivisor + '&nbsp;&nbsp;&nbsp;&nbsp;播放日期： ' + ptdate;
					}
