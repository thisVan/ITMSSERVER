   ...
   <script type="text/javascript" defer="defer">
		...
		function ptableUnaccess(){
		    ...
		    if(checkArray.length == 0){
		    	layer.msg('请选择不通过理由!',{icon:5,time:1500});
		    	return ;
		    }
		    $.ajax({
		    	type: "POST",
				url: "<%=request.getContextPath()%>/ptable/playTableUnAccess.do",
				data: {"ppid" : pid,"checkArray":checkArray},
				traditional: true,
				dataType : "json",
				success : function(msg){
					var value = msg.toString();
		...
		function ptableAccess(){
			    ...
			    if(checkArray.length > 0){
			    	layer.msg('审核通过, 不应该提交不通过理由!',{icon:5,time:1500});
			    	return ;
			    }
			...
			$.ajax({
				...
				data: {"ppid" : pid,"sortNum":listFile},
				traditional: true,
				dataType : "json",
				success : function(msg){
					var value = msg.toString();
		...
		<fieldset id="menu_func_div" class="layui-elem-field">
	         ...
	         <div class="layui-field-box">
			    <div class="layui-inline">
			       <label class="layui-form-mid" id="ptableNameTwo">
						...
						<div class="layui-form-item">
					        <div class="layui-inline">
								...
								<div class="layui-input-inline"
									...
									<input type="checkbox" name="unAccessFlag" title="排播有误" value="1">
								</div>
								<div class="layui-input-inline"
									style="width: 150px; height: 35px;">
									<input type="checkbox" name="unAccessFlag" title="素材敏感信息" value="2">
								</div>
					        </div>
					     </div>
					</form>
