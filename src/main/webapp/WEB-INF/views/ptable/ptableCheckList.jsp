    	  ...
    	  layui.use('table', function(){
    		  ...
    		  table.render({
    		    ...
    		    ,cols: [[
    		      //{field:'id', width:'1%'}
    		      {field:'ptableName',width:250, event: 'set1', title: '播表名', fixed: true, sort: true}
    		      ,{field:'mark',width:150, event: 'set2', title: '备注'}
      		    ...
      		    ,{field:'insertFlag',width:100, event: 'set5', title: '播表类型', sort: true
      		      ...
      		      ,{field:'statusId',width:110, event: 'set6', title: '审核状态', sort: true
      		    	  ,templet: function(d){
      		    		  var state = d.statusId;
      		    		if(state == 1){
  		    			  return '<span style="color: #FF6347;">' + '未审核' + '</span>';
      		      ...
      		      ,{fixed: 'right', width:100, event: 'set13', title: '操作', align:'center', toolbar: '#barDemo'}
      		    ]]
    		    ,page: true
    		    ,where: {"statusId":statusId}
    		    ,done: function(res, curr, count){
						...
						<div class="layui-form-item">
							...
							<div class="layui-inline">
								...
								<div class="layui-input-inline"
									...
									<select id="statusId" name="statusId" style="width: 150px; height: 35px;" lay-filter="test">
