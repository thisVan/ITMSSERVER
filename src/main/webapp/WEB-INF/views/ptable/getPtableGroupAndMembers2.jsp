                ...
                <form class="layui-form" id="query_form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            <div class="layui-inline">
                                <button class="layui-btn" type="button" onclick="groupCheck()">
                                    <i class="layui-icon">&#xe605;</i>同组播表审核
                                </button>
                            </div>
                        </div>
                        <div class="layui-inline">
                            <div class="layui-inline">
                                <button class="layui-btn" type="button" onclick="groupUnCheck()">
                                    <i class="layui-icon">&#x1006;</i>单播表审核
                                </button>
                            </div>
                        </div>
                    </div>
