   ...
   $(function(){
      ...
      function init(){
    	  ...
    	  value = $("#searchTerminalName").val();
		   ...
		   if(value != "") {
			   params = params + "locateIp" + ",like,%" + value + "%,";
		   }
		   
		   value = $("#searchLogContent").val();
		   if(value != "") {
			   params = params + "logContent" + ",like,%" + value + "%,";
		   }
    		  ...
    		  table.render({
    		    ...
    		    ,cols: [[
    		      ...
    		      {field:'terminalName',width:320, event: 'set1', title: '播放端名称', fixed: true, sort: true}
      		      ,{field: 'logContent',width:300, event: 'set2', title: '日志内容', sort: true}
      		      ,{field:'recordDate',width:250, event: 'set3', title: '记录时间', sort: true
      		    	,templet: function(d){
      		      ...
      		      ,{field:'locateIp',width:250, event: 'set4', title: '公网IP'}
      		    ]]
    		    ,page: true
					...
					<form class="layui-form" id="query_form">
						<div class="layui-form-item">
							<div class="layui-inline">
								<label class="layui-form-mid">日志内容：</label>
								<div class="layui-input-inline"
									style="width: 100px; height: 35px;">
									<input type="tel" id="searchLogContent" name="searchLogContent" autocomplete="off"
							...
							<div class="layui-inline">
								<label class="layui-form-mid">公网IP：</label>
								<div class="layui-input-inline"
									style="width: 100px; height: 35px;">
									<input type="tel" id="searchLocateIp" name="searchLocateIp" autocomplete="off"
										style="width: 100px; height: 35px;" placeholder="公网IP"
										class="layui-input input-text" />
								</div>
							</div>
