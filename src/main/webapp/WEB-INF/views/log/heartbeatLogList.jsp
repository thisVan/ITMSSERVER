      ...
      function init(){
    	  ...
    	  layui.use('table', function(){
    		  ...
    		  table.render({
    		    ...
    		    ,cols: [[
    		      //{field:'id', width:'1%'}
    		      {field:'terminalName',width:550, event: 'set1', title: '播放端名称', fixed: true, sort: true}
      		      ,{field:'recordTime',width:570, event: 'set2', title: '心跳记录日期', sort: true
      		    	,templet: function(d){
  		    		  var date = new Date(d.recordTime);
				...
				<div class="layui-form-query">
					<form class="layui-form" id="query_form">
						<div class="layui-form-item">
							...
							<div class="layui-inline">
			                    <label class="layui-form-mid">心跳记录日期：</label>
			                    <div class="layui-inline" style="">
				                    <input type="text" id="searchRecordTime" name="searchRecordTime" autocomplete="off" style="width: 170px; height: 36px;" class="layui-input fsDate" dateRange="1" placeholder=" - "/>
			                    </div>
		                    </div>
