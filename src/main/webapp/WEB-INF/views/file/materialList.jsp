    	  ...
    	  layui.use('table', function(){
    		  ...
    		  table1.render({
    		    ...
    		    ,cols: [[
    		     ...
    		     /*  ,{field:'playDate',width:200, event: 'set10', title: '播放日期', sort: true}
    		      ,{field:'playTime',width:200, event: 'set11', title: '播放时段', sort: true}
    		      ,{field:'frequency',width:100, event: 'set12', title: '频次', sort: true} */
    		      ,{field:'uploadTime',width:160, event: 'set10', title: '上传时间', sort: true
    		    	  ,templet: function(d){
    		    		  var date = new Date(d.uploadTime);
    		    		  var Y = date.getFullYear() + '-';
