...
<head>
    ...
    <script type="text/javascript" defer="defer">
        ...
        function init(){
            ...
            var params = "modifyObjectType, = ,RESET,";
            ...
            layui.use('table', function(){
                ...
                table.render({
                    elem: '#table1'
                    ,id: 'flagOne'
                    ,url:'<%=request.getContextPath()%>/audit/getAllResetAuditLog.do'
                    //,height: 550
                    //,cellMinWidth: 120
                    ,height:'full-200'
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline"
                                ...
                                <select id="operation" name="operation" style="width: 150px; height: 35px;">
                                    ...
                                    <option value="RESET_MATERIAL">反审核稿件</option>
                                    <option value="RESET_PTABLE">反审核播表</option>
                                    <option value="RESET_MARQUEE">反审核LOGO/图片叠加</option>
                                </select>
                            </div>
                        </div>
