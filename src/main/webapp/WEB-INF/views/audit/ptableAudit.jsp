        ...
        function init(){
            ...
            layui.use('table', function(){
                ...
                table.render({
                    elem: '#table1'
                    ,id: 'flagOne'
                    ,url:'<%=request.getContextPath()%>/audit/getAllPtableAuditLog.do'
                    //,height: 550
                    //,cellMinWidth: 120
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline"
                                ...
                                <select id="operation" name="operation" style="width: 150px; height: 35px;">
                                    ...
                                    <option value="PLAY_TABLE_GENERATION">播表生成</option>
                                    <option value="PLAY_TABLE_COPY_ITEM">从播表中复制节目</option>
                                    <option value="PLAY_TABLE_DELETE_ITEM">从播表中删除节目</option>
                                    <option value="PLAY_TABLE_FIRST_LEVER_REVIEW_ACCESS">通过的一级播表审核</option>
                                    <option value="PLAY_TABLE_FIRST_LEVER_REVIEW_UNACCESS">不通过的一级播表审核</option>
                                    <option value="PLAY_TABLE_FINAL_LEVER_REVIEW_ACCESS">通过的二级播表审核</option>
                                    <option value="PLAY_TABLE_FINAL_LEVER_REVIEW_UNACCESS">不通过的二级播表审核</option>
                                </select>
                            </div>
                        </div>

                        <div class="layui-inline">
                            <label class="layui-form-mid">播表ID：</label>
                            <div class="layui-input-inline"
                                 style="width: 100px; height: 35px;">
