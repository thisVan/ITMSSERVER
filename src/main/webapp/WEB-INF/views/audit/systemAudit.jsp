        ...
        function init(){
            ...
            layui.use('table', function(){
                ...
                table.render({
                    elem: '#table1'
                    ,id: 'flagOne'
                    ,url:'<%=request.getContextPath()%>/audit/getAllSystemAuditLog.do'
                    //,height: 550
                    //,cellMinWidth: 120
                    ,height:'full-200'
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline"
                                ...
                                <select id="operation" name="operation" style="width: 150px; height: 35px;">
                                    ...
                                    <option value="SYSTEM_LOGIN">登录</option>
                                    <option value="SYSTEM_ADD_USER">增加用户</option>
                                    <option value="SYSTEM_MODIFY_USER">修改用户</option>
                                    <option value="SYSTEM_DELETE_USER">删除用户</option>
                                    <option value="SYSTEM_ADD_ROLE">增加角色</option>
                                    <option value="SYSTEM_MODIFY_ROLE">修改角色</option>
                                    <option value="SYSTEM_DELETE_ROLE">删除角色</option>
                                    <option value="SYSTEM_ADD_TERMINAL">增加终端</option>
                                    <option value="SYSTEM_MODIFY_TERMINAL">修改终端</option>
                                    <option value="SYSTEM_DELETE_TERMINAL">删除终端</option>
                                    <option value="SYSTEM_STOP_TERMINAL">停止终端</option>
                                    <option value="SYSTEM_RESTART_TERMINAL">重启终端</option>
                                </select>
                            </div>
                        </div>
