...
<input type="hidden" id="itemnum" value=""/>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input type="text" id="testDate" name="testDate"  style="width:250px;" class="layui-input input-text" readonly="readonly"/>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      ...
      <input type="text" id="periodName" name="periodName" required=""  style="width:250px;"  lay-verify="required"  autocomplete="off" class="layui-input input-text" readonly="readonly"/>
    </div>
