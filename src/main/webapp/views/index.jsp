...
div[carousel-item]>*:nth-child(4n) {
	background-color: #009688;
}

div[carousel-item]>*:nth-child(4n+1) {
	background-color: #5FB878;
}

div[carousel-item]>*:nth-child(4n+2) {
	background-color: #01AAED;
}

div[carousel-item]>*:nth-child(4n+3) {
...
<body>
	<div class="layui-layout layui-layout-admin">
			...
			<ul class="layui-nav layui-layout-right">
				...
				<li class="layui-nav-item"><a href="javascript:;"
					style="text-decoration:none" class="admin-header-user"> <img
						src="<%=request.getContextPath()%>/layui/images/100.jpg"
						class="layui-nav-img" /> <span id="name"><%=session.getAttribute("userName")%></span>
				</a>
					<dl class="layui-nav-child">
						...
						<dd>
							<a href="javascript:;" onClick="set()"
								style="text-decoration:none"><i class="fa fa-gear"
			...
			<div class="layui-side-scroll">
				<ul class="layui-nav layui-nav-tree left-menu" lay-filter="tabDemo">
					<c:forEach var="item" items="${resourcesMap}">
						<li class="layui-nav-item"><a href="javascript:;"
							style="text-decoration:none">${item.key}</a>
							<dl class="layui-nav-child">
								<c:forEach items="${item.value}" var="col">
									<dd>
										<a class="zn-tab-add"
											zn-href="<%=request.getContextPath()%>${col.resourceUrl}"
		...
		<div class="layui-body layui-form">
			<div class="layui-tab layui-tab-card fsTab" lay-filter="tabDemo"
				lay-allowClose="true">
	...
	<script type="text/javascript">
		...
		var sessionTimeout = 59 * 60 * 1000; //设置超时时间，session超时时间为60分
		...
		function timeOutLogout(){
			...
			if(currentTime - lastTime > sessionTimeout){ //判断是否超时
				//登出系统
				logout();
			}
		}	
