...
<script type="text/javascript">
      ...
      */              
        ...
        function timeFirstCheck() {
        	$.ajax({
        		type: "POST",
        		url: "<%=request.getContextPath()%>/file/notifyFile.do",
        		dataType: "json",
		...
		<div class="easyui-accordion" fit="true" border="false">
			...
			<div title="播放管理">
				<ul>
					...
					<li><div>
							<a href="javascript:void(0)"
								onclick="addTab('播放控制', '<%=request.getContextPath()%>/playerController/playCenter.do');">播放控制</a>
						</div></li>
					<li><div>
							<a href="javascript:void(0)"
				...
				<ul>
					...
					<li><div>
							<a href="javascript:void(0)" id="fileTranslate"
								onclick="addTab('传输文件', '<%=request.getContextPath()%>/file/transferList.do');">传输文件</a>
						</div></li>
				</ul>
			</div>
